...
public class Constants {
    ...
    public static final String LECTURE_HALL_2_VALUE = "312";

    public static final String SUBJECT_1_VALUE = "math";
    public static final String SUBJECT_2_VALUE = "physic";
